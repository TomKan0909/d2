        ...
        <LabelLayout {...props}>
            <Container>
                <InputFragment
                    ...
                    onChange={(e: SyntheticEvent<HTMLInputElement, Event>): void => handleChange(e)}
                    onKeyDown={(e: SyntheticEvent<HTMLInputElement, Event>): void => handleChange(e)}
                    onClick={(e: SyntheticEvent<HTMLInputElement, Event>): void => handleChange(e)}
                />
