...
// export const DeliveryRadius: React.FC<IDeliveryRadiusProps> = ({
//     componentWidth,
//     title,
//     description,
//     leftMarkContent,
...
//         map,
//         mapCoordinates,
//         <Icon as={LocationCurrent} height={MAP_MARK_ICON_HEIGHT} />,
//     );
...
//                 <TopPanel
//                     height={componentWidth * MAP_ASPECT_RATIO}
//                     ref={mapContainer}
//                 />
//                 <BottomPanel>
//                     <Paragraph size="h1" bold>
//                         {title}
//                     </Paragraph>
...
//                             marks={{
//                                 [sliderProps?.min || 0]: (
//                                     <Paragraph size={SLIDER_MARK_SIZE} bold>
//                                         {leftMarkContent}
//                                     </Paragraph>
//                                 ),
//                                 [sliderProps?.max || 100]: (
...
//         ${Theme.dimensions.padding.container}
//         ${parseInt(Theme.dimensions.padding.container as string, DECIMAL_BASE) *
//         TIMES_THEME_CONTAINER_PADDING_BIS}px
//         ${Theme.dimensions.padding.container};
...
//     padding: ${parseInt(
//         Theme.dimensions.padding.container as string,
//         DECIMAL_BASE,
//     ) * TIMES_THEME_CONTAINER_PADDING}px;
